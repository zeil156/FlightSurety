...
contract FlightSuretyData {
    ...
    */
                                ...
                                public 
    {
        ...
        airlines[msg.sender].airAddr = msg.sender;
    ...
    */
    ...
    {
        require((fundsAvail - (flights[getFlightKey(airline, flight, timestamp)].riskAmt) >= 0), "Not enough funds for payout");
        _;
    }
    ...
    */      
    ...
    function isRegistered(address airAddr)
                            public
                            view
                            returns(bool)
    {
        return airlines[airAddr].isRegistered;
    }
    
    function isQueued(address airAddr)
                            public
                            view
                            returns(bool)
    {
        return airlines[airAddr].isQueued;
    }
    
    function isFunded(address airAddr)
                            public
                            view
                            returns(bool)
    {
        return airlines[airAddr].isFunded;
    }

    function alreadyQueued(address airAddr)
                            public
                            view
                            returns(bool)
    {
    ...
    function airVoteCount(address airAddr)
                            public
                            view
                            returns(uint256) {
        return airlines[airAddr].voteAmt;
    }

    function voteStatus(address airAddr, address msgSender)
                            public
                            view
                            returns(bool) {
        if(!airlines[airAddr].voters[msgSender]) {
            return false;
        } else {
            return true;
        }        
    ...
    */   
                            ...
                            requireIsOperational
    {
        ...
        require(!airlines[airAddr].isRegistered, "Airline is already registered.");

        airlines[airAddr] = Airline({
                                                airAddr: airAddr,
                                                airName: airName,
                                                isQueued: true,
    ...
    */  
                                ...
                                external
    {
        ...
        flights[flightKey].airline = airAddr;
    ...
    */   
                            ...
                            returns(uint256)
    {
        ...
        insuranceContracts[insuranceContractKey] = InsuranceContract ({
                                                ...
                                                passengerAddr: passenger,       // msg.sender
                                                isPaid: false,
                                                payAmt: payout,
                                                isActive: true
                                        });
    ...
    */   
    ...
    function regQueuedAirline(address airAddr) 
                            external
                            requireIsOperational
                            returns(bool)
    {
        airlines[airAddr].isRegistered = true;
        numRegisteredAirlines++;
        return true;
    }

    function voteForAirReg(address airAddr, uint256 updatedVoteAmt) 
                            external
                            requireIsOperational
    {
        airlines[airAddr].voters[msg.sender] = true;
        airlines[airAddr].voteAmt = updatedVoteAmt;
    }
